...
class Judge(models.Model):
    ...
    education = models.ForeignKey(
        ...
        help_text=(
            "Which option best describes your level of education? We "
    ...
    fair_experience = models.ForeignKey(
        ...
        help_text=(
            "How many years have you judged science fairs at the "
    ...
    def save(
        ...
        transaction.on_commit(
            lambda: self.post_commit.send(sender=Judge, instance=self)
        )
...
def create_judge(
    ...
    user, save_user = User.objects.get_or_create(
        username=username,
