...
CONSTANCE_CONFIG = {
    ...
    "JUDGES_PER_PROJECT": (
        3,
        "The number of judges that should be assigned to judge each project",
    ),
    "PROJECTS_PER_JUDGE": (
        5,
        "The minimum number of projects that should be assigned to each judge",
    ),
    "JUDGING_ACTIVE": (False, "Check this box during judging"),
    "RUBRIC_NAME": (
        "Judging Form",
        "The name of the rubric judges will use to assess projects",
    ),
}
